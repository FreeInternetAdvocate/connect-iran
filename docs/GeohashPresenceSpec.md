...
> Location-based presence for Connect Iran mesh network.
...
**Privacy Note:** For user safety in Iran, presence is only broadcast at low-precision geohash levels (city/province/region). High-precision location is never revealed.
